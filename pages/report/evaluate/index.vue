...
<div class="evaluate-report">
    <div class="evaluate-report-header">
        <v-col cols="10" class="reports-title">فهرست گزارش ارزیابی دوره‌ای</v-col>
        <v-col cols="2 d-flex justify-end">
            <SVGBack class="back-icon" @click="$router.push('/')" />
        </v-col>
    </div>
    <!-- <v-col cols="12" class="d-flex justify-center" v-if="!reports.length && !loading">ارزیابی ثبت شده‌ای برای نمایش وجود ندارد</v-col> -->
    <div class="loading d-flex justify-center" v-if="loading">
        <img :src="require('assets/images/loading.gif')" alt="loading">
    </div>
    <v-col cols="12" class="d-flex justify-center" v-if="!loading">ارزیابی ثبت شده‌ای برای نمایش وجود ندارد</v-col>
